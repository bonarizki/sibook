                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="580" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p25t es-p25b es-p10r es-p10l" align="center" style="font-size:0"><a href target="_blank"><img src="https://wwcxfa.stripocdn.email/content/guids/CABINET_3df254a10a99df5e44cb27b842c2c69e/images/7331519201751184.png" alt style="display: block;" width="40"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="left">
                                                                                        <p>Congratulations {{ ucfirst($user->name) }}, you have successfully registered into the EBOOK (Wotish Cafe)</p>
                                                                                    </td>
                                                                                </tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text" align="left">
                                                                                        <p><b>Alamat :<br>Kompleg Bulog, Jl. Raya Pos Pengumben Selatan, RT.5/RW.6,</b></p>
                                                                                        <p><b>South Sukabumi, Kebon Jeruk, Suka bumi, Jakarta 11560<br>Phone Admin :<br>082145104751</b><br></p>
                                                                                        <p><b>Email:<br>wotishmanagement@gmail.com</b><br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
